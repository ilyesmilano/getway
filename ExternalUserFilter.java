...
public class ExternalUserFilter implements GatewayFilter {
    ...
    // // Define your logic to check if the IP address belongs to an External user
    // // This could be based on a predefined list of External IP addresses
    // // Return true for External users and false for others
    // // Example: return ipAddress.equals("External_IP_ADDRESS");
    // return false;
    // }
